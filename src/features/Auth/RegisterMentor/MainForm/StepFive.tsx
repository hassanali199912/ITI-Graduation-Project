...
export default function StepFive({ data, updateData, triggerSubmit }: Props) {
  ...
  const onSubmit = async (formData: StepFiveData) => {
    console.log("step five ", formData);
              ...
              <div className="flex w-full items-center mb-8">
                ...
                <div className="flex gap-2 w-1/2">
                  <div className="w-1/2">
                    ...
                    <SelectInput<StepFiveData>
                      id={`exams.${index}.examMonth`}
                      label="الشهر"
                  ...
                  <div className="w-1/2">
                    ...
                    <SelectInput<StepFiveData>
                      id={`exams.${index}.examYear`}
                      label="السنة"
                      options={years.map((year) => ({ id: year.toString(), name: year.toString() }))}
                      register={register}
                    />
