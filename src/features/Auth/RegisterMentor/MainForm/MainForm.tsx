...
//   // const [triggerCountries , {data : countries , isError , isLoading}] = useLazyGetCountriesQuery();
//   // useEffect(() => {
//   //     triggerCountries();
//   //     console.log(triggerCountries());
//   // }, [])
//   // useEffect(() => {
//   //   if(countries){
...
//   // if (isError) return <p>حدث خطأ أثناء تحميل الدول</p>;
