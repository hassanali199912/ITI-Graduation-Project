...
import { FaHome, FaUserGraduate, FaCog, FaSignOutAlt } from "react-icons/fa";
...
const SidebarMentor: React.FC<Props> = ({ setView }) => {
  const navigate=useNavigate();
  return (
    <div className="min-h-screen w-64 bg-blue-800 text-white flex flex-col p-6 shadow-lg sticky top-0">

      <div className="text-2xl font-bold mb-10 text-center">لوحة التحكم المرشد</div>
