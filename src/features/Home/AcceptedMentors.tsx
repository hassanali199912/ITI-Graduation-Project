    ...
    const fetchMentors = async (page: number) => {
        ...
        try {
            const res = await fetch(
                `http://academix1.runasp.net/api/GetTeachers?status=0&pageNumber=${page}&pageSize=${pageSize}`
            );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" dir="rtl">
                {mentors.map((mentor, i) => (
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mb-3">الحالة: مقبول</p>
                        <button
...
export default AcceptedMentors;